...
void main() async {
  try {
    ...
    // Test FF_ranks.csv
    try {
      final data1 = await rootBundle.loadString('assets/2025/FF_ranks.csv');
    ...
    try {
      final data2 = await rootBundle.loadString('assets/2026/available_players.csv');
    ...
    try {
      final data3 = await rootBundle.loadString('assets/current_players_combined.csv');
