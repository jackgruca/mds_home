...
class ComprehensiveTEAnalyticsScreen extends StatefulWidget {
  const ComprehensiveTEAnalyticsScreen({super.key});

  @override
  State<ComprehensiveTEAnalyticsScreen> createState() => _ComprehensiveTEAnalyticsScreenState();
}

class _ComprehensiveTEAnalyticsScreenState extends State<ComprehensiveTEAnalyticsScreen>
  ...
  // Define the 5 comprehensive TE data sections
  final List<Map<String, dynamic>> _dataSections = [
    ...
    },
    {
      ...
      'fields': [
        ...
        {'key': 'completion_percentage', 'label': 'Comp %', 'type': 'percentage', 'width': 80.0},
  ...
  Future<void> _loadTEData() async {
    ...
    try {
      ...
      // Load TE data with CSV performance for selected seasons
      ...
      // Filter for minimum targets (15+ for current season, 60+ for multi-season)
      final minTargets = _selectedSeasons.length == 1 ? 15 : 60;
      final filteredData = allTEs
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(
        titleWidget: Text('🏈 Comprehensive TE Analytics'),
      ),
      body: Stack(
        children: [
          Column(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${_teData.length} Qualified TEs • Receiving, Versatility & Advanced Metrics',
                      style: TextStyle(
                        fontSize: 14,
          ...
          child: SingleChildScrollView(
            ...
            child: SingleChildScrollView(
              child: DataTable(
                      ...
                      rows: _teData.take(50).map((te) { // Limit to top 50 for performance
                        return DataRow(
