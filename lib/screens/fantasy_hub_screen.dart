...
class FantasyHubScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final NavItem? hubItem =
        topNavItems.firstWhereOrNull((item) => item.route == '/fantasy');
                        ...
                        child: ResponsiveLayoutBuilder(
                          ...
                          desktop: (context) => Row(
                            ...
                            children: [
                              Expanded(
                                  flex: 2,
                                  child: HomeSlideshow(slides: _slides)),
                              const SizedBox(width: 32),
                              Expanded(
                                  flex: 1,
                                  child: StackedToolLinks(tools: hubTools)),
                            ],
                          ),
                        ),
                      ),
  ...
  Widget _buildToolLink(BuildContext context, String title, String description,
