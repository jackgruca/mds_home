// lib/screens/tag_results_screen.dart
...
class _TagResultsScreenState extends State<TagResultsScreen> {
  ...
  Future<void> _loadPosts() async {
    ...
    try {
      final posts = await BlogService.searchPostsByTag(widget.tag);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Posts tagged: #${widget.tag}'),
      ),
      body: _isLoading
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'No posts found with tag #${widget.tag}',
                        style: TextStyle(
                          fontSize: 18,
