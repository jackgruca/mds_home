...
class ComprehensiveWRAnalyticsScreen extends StatefulWidget {
  const ComprehensiveWRAnalyticsScreen({super.key});

  @override
  State<ComprehensiveWRAnalyticsScreen> createState() => _ComprehensiveWRAnalyticsScreenState();
}

class _ComprehensiveWRAnalyticsScreenState extends State<ComprehensiveWRAnalyticsScreen>
  ...
  // Define the 5 comprehensive WR data sections
  final List<Map<String, dynamic>> _dataSections = [
    ...
    },
    {
      ...
      'fields': [
        ...
        {'key': 'percent_share_of_intended_air_yards', 'label': 'Int Air %', 'type': 'percentage', 'width': 90.0},
    ...
    },
    {
      ...
      'subtitle': 'Rushing & passing contributions',
      'color': Colors.purple,
    ...
    },
    {
      ...
      'fields': [
        ...
        {'key': 'completion_percentage_above_expectation', 'label': 'CPOE', 'type': 'decimal', 'width': 70.0},
        {'key': 'rush_yards_over_expected_per_att', 'label': 'RYOE/Att', 'type': 'decimal', 'width': 90.0},
  ...
  Future<void> _loadWRData() async {
    ...
    try {
      ...
      // Load WR data with CSV performance for selected seasons
      ...
      // Filter for minimum targets (20+ for current season, 80+ for multi-season)
      final minTargets = _selectedSeasons.length == 1 ? 20 : 80;
      final filteredData = allWRs
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(
        titleWidget: Text('🎯 Comprehensive WR Analytics'),
      ),
      body: Stack(
        children: [
          Column(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${_wrData.length} Qualified WRs • Route Running, Separation & Target Analytics',
                      style: TextStyle(
                        fontSize: 14,
          ...
          child: SingleChildScrollView(
            ...
            child: SingleChildScrollView(
              child: DataTable(
                      ...
                      rows: _wrData.take(50).map((wr) { // Limit to top 50 for performance
                        return DataRow(
