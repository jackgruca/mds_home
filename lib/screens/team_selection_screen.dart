...
class _TeamSelectionScreenState extends State<TeamSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final double teamLogoSize = isSmallScreen
        ? (isVerySmallScreen ? 42.0 : 48.0)
        : 56.0; // Larger logo sizes for all screens
    final double fontSize =
        isSmallScreen ? (isVerySmallScreen ? 9.0 : 10.0) : 11.0;
    final double sectionPadding =
        isSmallScreen ? 4.0 : 8.0; // Reduced padding for more space
    const double teamButtonSpacing = 1.0; // Minimized spacing

    // Define theme colors - adjusting for dark mode
    final Color afcColor = isDarkMode
        ? const Color(0xFFFF6B6B)
        : const Color(0xFFD50A0A); // Brighter red for dark mode
    final Color nfcColor = isDarkMode
        ? const Color(0xFF4D90E8)
        : const Color(0xFF002244); // Brighter blue for dark mode
      ...
      body: SafeArea(
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  SizedBox(
                    ...
                    width: 18,
                    child: Checkbox(
                      value: _selectedTeams.isNotEmpty &&
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.symmetric(
                                horizontal: sectionPadding, vertical: 6.0),
                            width: double.infinity,
                            child: const Text(
                              'AFC',
                              style: TextStyle(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          color: isDarkMode
                                              ? Colors.white
                                              : afcColor, // Ensure visibility in dark mode
                                        ),
                                      ),
                                    ),
                                    ...
                                    Row(
                                      children: teams.map((team) {
                                        ...
                                        final abbr = NFLTeamMappings
                                                .fullNameToAbbreviation[team] ??
                                            '';

                                        return Expanded(
                                          child: Center(
                                            // Center the content to maximize logo visibility
                                            child: Container(
                                              margin: const EdgeInsets.all(
                                                  teamButtonSpacing),
                                              padding: EdgeInsets
                                                  .zero, // No internal padding
                                              decoration: BoxDecoration(
                                                border: isSelected
                                                    ? Border.all(
                                                        color: Colors.blue,
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        width: teamLogoSize +
                                                            (isSelected
                                                                ? 6
                                                                : 0), // Slightly larger when selected
                                                        height: teamLogoSize +
                                                            (isSelected
                                                                ? 6
                                                                : 0),
                                                        decoration:
                                                          ...
                                                          boxShadow: isSelected
                                                              ? [
                                                                  const BoxShadow(
                                                                      color: Color(
                                                                          0x668bb5d9), // Changed from Colors.amber.withOpacity(0.4)
                                                                      blurRadius:
                                                                          6,
                                                                      spreadRadius:
                                                                          2)
            ...
            Container(
              padding: EdgeInsets.symmetric(
                  horizontal: sectionPadding, vertical: 8.0),
              decoration: BoxDecoration(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: SliderTheme(
                                    ...
                                    child: Slider(
                                      value: _randomness *
                                          5, // Convert to 1-5 scale for UI
                                      min: 1.0,
                                      max: 5.0,
                                      divisions: 4,
                                      activeColor: Colors.green[
                                          700], // Use a different color than speed
                                      onChanged: (value) {
                                        setState(() {
                                          _randomness = value /
                                              5.0; // Convert back to 0-1 scale
                                        });
                                      },
                                    ),
                                  ),
                                ),
                                Text('${(_randomness * 5).toInt()}',
                                    style: const TextStyle(fontSize: 12.0)),
                              ],
                            ),
                          ],
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed:
                                _selectedTeams.isNotEmpty ? _startDraft : null,
