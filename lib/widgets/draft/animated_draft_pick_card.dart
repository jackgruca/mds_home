...
Widget build(BuildContext context) {
  ...
  return FadeTransition(
    ...
    child: ScaleTransition(
      ...
      child: Card(
        elevation: widget.isCurrentPick ? 3.0 : 1.0,
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
            ...
            width: widget.isCurrentPick ? 2.0 : 1.0,
          ),
        ),
        color: widget.isActualPick
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Add an actual pick indicator
                  if (widget.isActualPick && widget.draftPick.selectedPlayer != null)
                    Padding(
