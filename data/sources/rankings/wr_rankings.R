...
write_csv(WR_ranks_final, file = "/Users/jackgruca/Documents/GitHub/mds_home/data/processed/rankings/wr_rankings.csv")

print(paste("Processed", nrow(WR_ranks_final), "WR rankings and saved to wr_rankings.json and wr_rankings.csv"))